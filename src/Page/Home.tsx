...
const Home = () => {
    ...
    const [additionalDetails , setAdditionl] = useState<Link[]>([])
   ...
   const  handleaddLinks = (url:string ,label:string)=>{
        setEnablelink(true)
        
        setAdditionl((link)=>[...link , {label, url} ])
        seturl("")
        setlabel("")
    }
    ...
    const handleFinalSend = async () => {
        ...
        try {
            ...
            const res = await fetch("https://vercel.com/vaibhavbarala26s-projects/cold-server-bj3d/9htjkMwvnwQcy5wQzWpE2rPDGkwB/email", {
                method: "POST",
                headers: {
        ...
        try {
            ...
            // Send the emails to the server
            const res = await fetch("https://vercel.com/vaibhavbarala26s-projects/cold-server-bj3d/9htjkMwvnwQcy5wQzWpE2rPDGkwB/email/schedule", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json", // Ensure the server expects JSON
                },
                                                ...
                                                <div>
                                                    ...
                                                    <div className='px-2 mt-4'>
                                                        ...
                                                        {enableLink ? (
                                                            ...
                                                            <Button onClick={()=>(handleaddLinks(url , label))}>add</Button>
                                                            </div>
                                                        ):(null)}
